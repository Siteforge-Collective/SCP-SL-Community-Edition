public class PermissionsHandler
{
	...
	{
		UserGroup userGroup = ((string.IsNullOrEmpty(userId) || !_members.ContainsKey(userId)) ? null : _groups[_members[userId]]);
		global::PluginAPI.Events.PlayerGetGroupCancellationData playerGetGroupCancellationData = global::PluginAPI.Events.EventManager.ExecuteEvent<global::PluginAPI.Events.PlayerGetGroupCancellationData>(global::PluginAPI.Enums.ServerEventType.PlayerGetGroup, new object[2] { userId, userGroup });
		if (!playerGetGroupCancellationData.IsCancelled)
		{
			return userGroup;
		}
		return playerGetGroupCancellationData.AssignedUserGroup;
	}
}
