public class PocketDimensionTeleport : global::Mirror.NetworkBehaviour
{
	...
	private void OnTriggerEnter(global::UnityEngine.Collider other)
	{
		...
		{
			if (global::PluginAPI.Events.EventManager.ExecuteEvent(global::PluginAPI.Enums.ServerEventType.PlayerExitPocketDimension, hub, false))
			{
		...
		else if ((_type == PocketDimensionTeleport.PDTeleportType.Exit || DebugBool) && hub.roleManager.CurrentRole is global::PlayerRoles.FirstPersonControl.IFpcRole fpcRole && global::PluginAPI.Events.EventManager.ExecuteEvent(global::PluginAPI.Enums.ServerEventType.PlayerExitPocketDimension, hub, true))
		{
