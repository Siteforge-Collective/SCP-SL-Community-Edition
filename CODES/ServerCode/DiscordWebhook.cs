public readonly struct DiscordWebhook : global::System.IEquatable<DiscordWebhook>, IJsonSerializable
{
	...
	{
		return (((((((((content != null) ? content.GetHashCode() : 0) * 397) ^ ((username != null) ? username.GetHashCode() : 0)) * 397) ^ ((avatar_url != null) ? avatar_url.GetHashCode() : 0)) * 397) ^ tts.GetHashCode()) * 397) ^ ((embeds != null) ? embeds.GetHashCode() : 0);
	}
