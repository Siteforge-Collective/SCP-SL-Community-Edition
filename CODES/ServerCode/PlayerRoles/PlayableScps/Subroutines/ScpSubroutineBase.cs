...
{
	public abstract class ScpSubroutineBase : global::UnityEngine.MonoBehaviour
	{
		...
		public byte SyncIndex
		{
			get
			{
				...
				global::PlayerRoles.PlayableScps.Subroutines.ScpSubroutineBase[] allSubroutines = ((Role as global::PlayerRoles.PlayableScps.Subroutines.ISubroutinedScpRole) ?? throw new global::System.InvalidOperationException("Could not generate a SyncIndex of '" + base.name + "' subroutine. The role does not derive from ISubroutinedScpRole!")).SubroutineModule.AllSubroutines;
		...
		protected virtual void OnValidate()
		{
			...
			{
				componentInParent.AllSubroutines = componentInParent.GetComponentsInChildren<global::PlayerRoles.PlayableScps.Subroutines.ScpSubroutineBase>();
			}
		}
		...
		protected void ClientSendCmd()
		{
			if (!Role.Pooled)
			{
				...
				global::Mirror.NetworkClient.Send(new global::PlayerRoles.PlayableScps.Subroutines.SubroutineMessage(this, isConfirmation: false));
			}
		}
		...
		protected void ServerSendRpc(bool toAll)
		{
			if (global::Mirror.NetworkServer.active && !Role.Pooled)
			{
				...
				if (toAll)
				{
					global::Mirror.NetworkServer.SendToReady(new global::PlayerRoles.PlayableScps.Subroutines.SubroutineMessage(this, isConfirmation: true));
				}
		...
		protected void ServerSendRpc(ReferenceHub target)
		{
			if (global::Mirror.NetworkServer.active && !Role.Pooled)
			{
				target.connectionToClient.Send(new global::PlayerRoles.PlayableScps.Subroutines.SubroutineMessage(this, isConfirmation: true));
			}
		}
		...
		protected void ServerSendRpc(global::System.Func<ReferenceHub, bool> condition)
		{
			if (global::Mirror.NetworkServer.active && !Role.Pooled)
			{
				global::Utils.Networking.NetworkUtils.SendToHubsConditionally(new global::PlayerRoles.PlayableScps.Subroutines.SubroutineMessage(this, isConfirmation: true), condition);
			}
		}
