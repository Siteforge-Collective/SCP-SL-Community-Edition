...
{
	public class Scp049ResurrectAbility : global::PlayerRoles.PlayableScps.Scp049.RagdollAbilityBase<global::PlayerRoles.PlayableScps.Scp049.Scp049Role>
	{
		...
		protected override void ServerComplete()
		{
			...
			if (global::PluginAPI.Events.EventManager.ExecuteEvent(global::PluginAPI.Enums.ServerEventType.Scp049ResurrectBody, base.Owner, ownerHub, base.CurRagdoll))
			{
		...
		protected override bool ServerValidateAny()
		{
			...
			if (!global::PluginAPI.Events.EventManager.ExecuteEvent(global::PluginAPI.Enums.ServerEventType.Scp049StartResurrectingBody, base.Owner, ownerHub, base.CurRagdoll, flag))
			{
				return false;
			}
			return flag;
