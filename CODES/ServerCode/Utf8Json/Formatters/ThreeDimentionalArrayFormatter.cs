...
{
	public sealed class ThreeDimentionalArrayFormatter<T> : global::Utf8Json.IJsonFormatter<T[,,]>, global::Utf8Json.IJsonFormatter
	{
		...
		public T[,,] Deserialize(ref global::Utf8Json.JsonReader reader, global::Utf8Json.IJsonFormatterResolver formatterResolver)
		{
			...
			global::Utf8Json.Internal.ArrayBuffer<global::Utf8Json.Internal.ArrayBuffer<global::Utf8Json.Internal.ArrayBuffer<T>>> arrayBuffer = new global::Utf8Json.Internal.ArrayBuffer<global::Utf8Json.Internal.ArrayBuffer<global::Utf8Json.Internal.ArrayBuffer<T>>>(4);
			global::Utf8Json.IJsonFormatter<T> formatterWithVerify = formatterResolver.GetFormatterWithVerify<T>();
			int num = 0;
			int num2 = 0;
			int count = 0;
			...
			{
				global::Utf8Json.Internal.ArrayBuffer<global::Utf8Json.Internal.ArrayBuffer<T>> value = new global::Utf8Json.Internal.ArrayBuffer<global::Utf8Json.Internal.ArrayBuffer<T>>((num2 == 0) ? 4 : num2);
				int count2 = 0;
				reader.ReadIsBeginArrayWithVerify();
				while (!reader.ReadIsEndArrayWithSkipValueSeparator(ref count2))
				{
					global::Utf8Json.Internal.ArrayBuffer<T> value2 = new global::Utf8Json.Internal.ArrayBuffer<T>((num == 0) ? 4 : num);
					int count3 = 0;
					reader.ReadIsBeginArrayWithVerify();
