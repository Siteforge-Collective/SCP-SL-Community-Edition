...
{
	internal sealed class DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateOriginal : global::Utf8Json.IJsonFormatterResolver
	{
		...
		{
			Instance = new global::Utf8Json.Resolvers.Internal.DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateOriginal();
			nameMutator = global::Utf8Json.Internal.StringMutator.Original;
			excludeNull = false;
			assembly = new global::Utf8Json.Internal.Emit.DynamicAssembly("Utf8Json.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateOriginal");
		}
		...
		{
			return global::Utf8Json.Resolvers.Internal.DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateOriginal.FormatterCache<T>.formatter;
		}
	}
}
