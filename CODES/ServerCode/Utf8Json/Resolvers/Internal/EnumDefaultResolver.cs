...
{
	internal sealed class EnumDefaultResolver : global::Utf8Json.IJsonFormatterResolver
	{
		private static class FormatterCache<T>
		{
			...
			static FormatterCache()
			{
				...
				{
					formatter = new global::Utf8Json.Formatters.EnumFormatter<T>(serializeByName: true);
				}
			}
		}

		public static readonly global::Utf8Json.IJsonFormatterResolver Instance = new global::Utf8Json.Resolvers.Internal.EnumDefaultResolver();
		...
		{
			return global::Utf8Json.Resolvers.Internal.EnumDefaultResolver.FormatterCache<T>.formatter;
		}
	}
}
