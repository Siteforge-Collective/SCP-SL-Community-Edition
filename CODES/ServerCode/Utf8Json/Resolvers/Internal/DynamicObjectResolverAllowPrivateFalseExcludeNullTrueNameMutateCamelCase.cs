...
{
	internal sealed class DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateCamelCase : global::Utf8Json.IJsonFormatterResolver
	{
		...
		{
			Instance = new global::Utf8Json.Resolvers.Internal.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateCamelCase();
			nameMutator = global::Utf8Json.Internal.StringMutator.ToCamelCase;
			excludeNull = true;
			assembly = new global::Utf8Json.Internal.Emit.DynamicAssembly("Utf8Json.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateCamelCase");
		}
		...
		{
			return global::Utf8Json.Resolvers.Internal.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateCamelCase.FormatterCache<T>.formatter;
		}
	}
}
