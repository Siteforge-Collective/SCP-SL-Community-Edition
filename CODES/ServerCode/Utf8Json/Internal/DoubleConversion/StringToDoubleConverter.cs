namespace Utf8Json.Internal.DoubleConversion
{
	internal static class StringToDoubleConverter
	{
		...
		private const global::Utf8Json.Internal.DoubleConversion.StringToDoubleConverter.Flags flags_ = (global::Utf8Json.Internal.DoubleConversion.StringToDoubleConverter.Flags)52;
		...
		{
			return StringToIeee(new global::Utf8Json.Internal.DoubleConversion.Iterator(buffer, offset), buffer.Length - offset, read_as_double: true, out readCount);
		}

		public static float ToSingle(byte[] buffer, int offset, out int readCount)
		{
			return (float)StringToIeee(new global::Utf8Json.Internal.DoubleConversion.Iterator(buffer, offset), buffer.Length - offset, read_as_double: false, out readCount);
		}
		...
		private static bool AdvanceToNonspace(ref global::Utf8Json.Internal.DoubleConversion.Iterator current, global::Utf8Json.Internal.DoubleConversion.Iterator end)
		{
			while (current != end)
			{
		...
		private static bool ConsumeSubString(ref global::Utf8Json.Internal.DoubleConversion.Iterator current, global::Utf8Json.Internal.DoubleConversion.Iterator end, byte[] substring)
		{
		...
		private static bool ConsumeFirstCharacter(ref global::Utf8Json.Internal.DoubleConversion.Iterator iter, byte[] str, int offset)
		{
		...
		private static double StringToIeee(global::Utf8Json.Internal.DoubleConversion.Iterator input, int length, bool read_as_double, out int processed_characters_count)
		{
			global::Utf8Json.Internal.DoubleConversion.Iterator current = input;
			global::Utf8Json.Internal.DoubleConversion.Iterator iterator = input + length;
			...
			if (current == '+' || current == '-')
			{
				flag6 = current == '-';
				++current;
				global::Utf8Json.Internal.DoubleConversion.Iterator current2 = current;
			...
			buffer[num] = 0;
			double? num7 = ((!read_as_double) ? ((double?)global::Utf8Json.Internal.DoubleConversion.StringToDouble.Strtof(new global::Utf8Json.Internal.DoubleConversion.Vector(buffer, 0, num), num2)) : global::Utf8Json.Internal.DoubleConversion.StringToDouble.Strtod(new global::Utf8Json.Internal.DoubleConversion.Vector(buffer, 0, num), num2));
			if (!num7.HasValue)
			{
				processed_characters_count = current - input;
				byte[] array = GetFallbackBuffer();
				global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref fallbackBuffer, 0, processed_characters_count);
				int count = 0;
				while (input != current)
				{
				...
				return double.Parse(global::System.Text.Encoding.UTF8.GetString(array, 0, count));
			}
			processed_characters_count = current - input;
			if (!flag6)
			{
