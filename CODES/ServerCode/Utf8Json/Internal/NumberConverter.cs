namespace Utf8Json.Internal
{
	public static class NumberConverter
	{
		...
		{
			return global::Utf8Json.Internal.DoubleConversion.StringToDoubleConverter.ToSingle(bytes, offset, out readCount);
		}

		public static double ReadDouble(byte[] bytes, int offset, out int readCount)
		{
			return global::Utf8Json.Internal.DoubleConversion.StringToDoubleConverter.ToDouble(bytes, offset, out readCount);
		}
		...
		public static int WriteUInt64(ref byte[] buffer, int offset, ulong value)
		{
			...
			if (num2 < 10000)
			{
				...
				if (num2 < 100)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 2);
					goto IL_0463;
				}
				if (num2 < 1000)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 3);
					goto IL_043e;
				}
			...
			if (num3 < 10000)
			{
				...
				if (num3 < 100)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 6);
					goto IL_03e2;
				}
				if (num3 < 1000)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 7);
					goto IL_03bd;
				}
				global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 8);
				goto IL_0395;
			}
			...
			if (num4 < 10000)
			{
				if (num4 < 10)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 9);
					goto IL_0386;
				}
				if (num4 < 100)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 10);
					goto IL_0361;
				}
				if (num4 < 1000)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 11);
					goto IL_033c;
				}
				global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 12);
				goto IL_0314;
			}
			...
			if (num5 < 10000)
			{
				if (num5 < 10)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 13);
					goto IL_0304;
				}
				if (num5 < 100)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 14);
					goto IL_02dc;
				}
				if (num5 < 1000)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 15);
					goto IL_02b4;
				}
				global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 16);
				goto IL_0289;
			}
			...
			if (num6 < 10000)
			{
				if (num6 < 10)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 17);
					goto IL_0279;
				}
				if (num6 < 100)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 18);
					goto IL_0251;
				}
				if (num6 < 1000)
				{
					global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 19);
					goto IL_0229;
				}
				global::Utf8Json.Internal.BinaryUtil.EnsureCapacity(ref buffer, offset, 20);
			}
			ulong num7;
		...
		{
			return global::Utf8Json.Internal.DoubleConversion.DoubleToStringConverter.GetBytes(ref bytes, offset, value);
		}
		...
		public static bool ReadBoolean(byte[] bytes, int offset, out int readCount)
		{
			if (bytes[offset] == 116)
			{
				...
				throw new global::System.InvalidOperationException("value is not boolean(true).");
			}
			if (bytes[offset] == 102)
			{
				...
				throw new global::System.InvalidOperationException("value is not boolean(false).");
			}
			throw new global::System.InvalidOperationException("value is not boolean.");
		}
	}
}
