...
{
	public abstract class AttackerDamageHandler : global::PlayerStatsSystem.StandardDamageHandler
	{
		private static float _ffMultiplier = 1f;

		private static bool _eventAssigned = false;

		public abstract global::Footprinting.Footprint Attacker { get; protected set; }
