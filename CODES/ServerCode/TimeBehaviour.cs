...
{
	public static long CurrentUnixTimestamp => global::System.DateTimeOffset.UtcNow.ToUnixTimeSeconds();

	public static long CurrentTimestamp()
	{
		return global::System.DateTime.UtcNow.Ticks;
	}

	public static long GetBanExpirationTime(uint seconds)
	{
		return global::System.DateTime.UtcNow.AddSeconds(seconds).Ticks;
	}
	...
	{
		return Rfc3339Time(global::System.DateTimeOffset.Now);
	}

	public static string Rfc3339Time(global::System.DateTimeOffset date)
	{
		return FormatTime((date.Offset == global::System.TimeSpan.Zero) ? "yyyy-MM-dd HH:mm:ss.fffZ" : "yyyy-MM-dd HH:mm:ss.fff zzz", date);
	}

	public static string FormatTime(string format)
	{
		return FormatTime(format, global::System.DateTimeOffset.Now);
	}

	public static string FormatTime(string format, global::System.DateTimeOffset date)
	{
