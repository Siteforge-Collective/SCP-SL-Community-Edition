...
{
	public class PhantomProjectile : global::UnityEngine.MonoBehaviour
	{
		...
		[global::UnityEngine.SerializeField]
		private global::UnityEngine.Vector3 _targetScale;
		...
		private global::InventorySystem.Items.ThrowableProjectiles.ThrownProjectile _pickupToReplace;
		...
		private void Replace()
		{
			if (_pickupToReplace != null)
			{
				if (_transitionFactor < 1f && _pickupToReplace.TryGetComponent<global::UnityEngine.Rigidbody>(out var component))
				{
					...
					Rigidbody.velocity = global::UnityEngine.Vector3.Lerp(Rigidbody.velocity, component.velocity, _transitionFactor);
