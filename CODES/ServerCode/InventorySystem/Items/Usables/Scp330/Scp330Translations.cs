namespace InventorySystem.Items.Usables.Scp330
{
	public static class Scp330Translations
	{
		...
		public static string GetEntryTranslation(global::InventorySystem.Items.Usables.Scp330.Scp330Translations.Entry entry)
		{
			return GetSpecificTranslation((int)entry, entry.ToString());
		}

		public static void GetCandyTranslation(global::InventorySystem.Items.Usables.Scp330.CandyKindID candyKind, out string name, out string desc, out string fx)
		{
