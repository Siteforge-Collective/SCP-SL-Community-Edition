...
{
	public class Scp1576Item : global::InventorySystem.Items.Usables.UsableItem
	{
		...
		private global::UnityEngine.AudioClip _warningStart;

		[global::UnityEngine.SerializeField]
		private global::UnityEngine.AudioClip _warningStop;
		...
		public global::InventorySystem.Items.Usables.Scp1576.Scp1576Playback PlaybackTemplate { get; private set; }
		...
		public override bool ServerValidateStartRequest(global::InventorySystem.Items.Usables.PlayerHandler handler)
		{
		...
		{
			if (!ReferenceHub.TryGetLocalHub(out var hub) || !(hub.inventory.CurInstance is global::InventorySystem.Items.Usables.Scp1576.Scp1576Item scp1576Item) || !(scp1576Item != null))
			{
				LocallyUsed = false;
			}
		}
		...
		private static void RevalidateReceivers()
		{
			...
			{
				if (!(allHub.roleManager.CurrentRole is global::PlayerRoles.FirstPersonControl.IFpcRole fpcRole2))
				{
