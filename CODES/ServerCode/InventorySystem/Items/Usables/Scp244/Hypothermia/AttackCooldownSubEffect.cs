...
{
	public class AttackCooldownSubEffect : global::InventorySystem.Items.Usables.Scp244.Hypothermia.HypothermiaSubEffectBase
	{
		private float _prevExpo;

		private static readonly global::System.Collections.Generic.Dictionary<uint, float> MultipliersOfPlayers = new global::System.Collections.Generic.Dictionary<uint, float>();
		...
		internal override void UpdateEffect(float curExposure)
		{
			...
			{
				float value = global::UnityEngine.Mathf.LerpUnclamped(1f, _cooldownMultiplierPerExposure, curExposure);
