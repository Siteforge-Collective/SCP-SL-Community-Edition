namespace InventorySystem.Items.Usables.Scp244
{
	...
	{
		private static readonly global::UnityEngine.Vector3 DoorDetectionThickness = new global::UnityEngine.Vector3(3f, 100f, 3f);

		private const float MinimalDoorGapSqrt = 9f;

		private const float BorderDoorCheck = 1.05f;

		public readonly global::UnityEngine.Bounds BoundsToEncapsulate;

		public readonly global::Interactables.Interobjects.DoorUtils.DoorVariant[] Doors;
