public readonly struct TranslationManifest : global::System.IEquatable<TranslationManifest>, IJsonSerializable
{
	...
	{
		if (string.Equals(Name, other.Name, global::System.StringComparison.OrdinalIgnoreCase) && Authors == other.Authors && InterfaceLocales == other.InterfaceLocales && SystemLocales == other.SystemLocales)
		{
	...
	{
		return (((((((((Name != null) ? global::System.StringComparer.OrdinalIgnoreCase.GetHashCode(Name) : 0) * 397) ^ ((Authors != null) ? Authors.GetHashCode() : 0)) * 397) ^ ((InterfaceLocales != null) ? InterfaceLocales.GetHashCode() : 0)) * 397) ^ ((SystemLocales != null) ? SystemLocales.GetHashCode() : 0)) * 397) ^ ((ForcedFontOrder != null) ? ForcedFontOrder.GetHashCode() : 0);
	}
