...
{
	public class AirlockController : global::Mirror.NetworkBehaviour, global::Interactables.IServerInteractable, global::Interactables.IInteractable
	{
		...
		private global::Interactables.Interobjects.DoorUtils.DoorVariant _doorA;

		[global::UnityEngine.SerializeField]
		private global::Interactables.Interobjects.DoorUtils.DoorVariant _doorB;
		...
		[global::UnityEngine.SerializeField]
		private global::UnityEngine.Animator _targetAnimator;
		...
		private void RpcAlarm()
		{
			...
			SendRPCInternal(typeof(global::Interactables.Interobjects.AirlockController), "RpcAlarm", writer, 0, includeOwner: true);
		...
		{
			AnimationTriggerHash = global::UnityEngine.Animator.StringToHash("Lockdown");
			global::Mirror.RemoteCalls.RemoteCallHelper.RegisterRpcDelegate(typeof(global::Interactables.Interobjects.AirlockController), "RpcAlarm", InvokeUserCode_RpcAlarm);
		}
		...
		private void UserCode_RpcAlarm()
		{
			_targetAnimator.SetTrigger(AnimationTriggerHash);
		}

		protected static void InvokeUserCode_RpcAlarm(global::Mirror.NetworkBehaviour obj, global::Mirror.NetworkReader reader, global::Mirror.NetworkConnectionToClient senderConnection)
		{
			if (!global::Mirror.NetworkClient.active)
			{
				global::UnityEngine.Debug.LogError("RPC RpcAlarm called on server.");
			}
			else
			{
				((global::Interactables.Interobjects.AirlockController)obj).UserCode_RpcAlarm();
			}
		}
	}
}
