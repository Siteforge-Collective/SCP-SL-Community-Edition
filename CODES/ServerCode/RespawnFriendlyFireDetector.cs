internal class RespawnFriendlyFireDetector : FriendlyFireDetector
{
	...
	private float _lastReset = global::UnityEngine.Time.unscaledTime;
	...
	{
		if (!FriendlyFireConfig.RespawnEnabled || _triggered || global::UnityEngine.Time.unscaledTime > _lastReset + (float)FriendlyFireConfig.RespawnWindow)
		{
			return false;
		}
	...
	{
		base.Reset();
		_lastReset = global::UnityEngine.Time.unscaledTime;
	}
}
