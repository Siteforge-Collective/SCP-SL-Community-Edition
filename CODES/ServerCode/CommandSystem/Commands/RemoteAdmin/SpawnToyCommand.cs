namespace CommandSystem.Commands.RemoteAdmin
{
	...
	public class SpawnToyCommand : global::CommandSystem.ICommand, global::CommandSystem.IUsageProvider
	{
		...
		public bool Execute(global::System.ArraySegment<string> arguments, global::CommandSystem.ICommandSender sender, out string response)
		{
			...
			foreach (global::UnityEngine.GameObject value in global::Mirror.NetworkClient.prefabs.Values)
			{
				if (value.TryGetComponent<global::AdminToys.AdminToyBase>(out var component))
				{
					if (flag)
					{
						response = response + "\n- " + component.CommandName;
					}
					else if (string.Equals(text, component.CommandName, global::System.StringComparison.InvariantCultureIgnoreCase))
					{
						global::AdminToys.AdminToyBase adminToyBase = global::UnityEngine.Object.Instantiate(component);
