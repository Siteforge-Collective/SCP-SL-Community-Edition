namespace CommandSystem.Commands.RemoteAdmin
{
	...
	public class ForceAttachmentsCommand : global::CommandSystem.ICommand, global::CommandSystem.IUsageProvider
	{
		...
		public bool Execute(global::System.ArraySegment<string> arguments, global::CommandSystem.ICommandSender sender, out string response)
		{
			...
			if (!(((global::RemoteAdmin.PlayerCommandSender)sender).ReferenceHub.inventory.CurInstance is global::InventorySystem.Items.Firearms.Firearm firearm))
			{
			...
			{
				uint num2 = global::InventorySystem.Items.Firearms.Attachments.AttachmentsUtils.ValidateAttachmentsCode(firearm, result);
				firearm.Status = new global::InventorySystem.Items.Firearms.FirearmStatus(firearm.Status.Ammo, firearm.Status.Flags, num2);
				ServerLogs.AddLog(ServerLogs.Modules.Administrative, string.Format("{0} forced attachments code {1} {2} for weapon {3}.", sender.LogName, result, (num2 == result) ? "" : $"(validated: {num2})", global::System.Enum.GetName(typeof(ItemType), firearm.ItemTypeId)), ServerLogs.ServerLogType.RemoteAdminActivity_GameChanging);
