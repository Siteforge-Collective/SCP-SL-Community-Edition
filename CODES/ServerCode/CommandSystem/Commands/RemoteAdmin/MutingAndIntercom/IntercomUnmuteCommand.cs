namespace CommandSystem.Commands.RemoteAdmin.MutingAndIntercom
{
	...
	public class IntercomUnmuteCommand : global::CommandSystem.ICommand, global::CommandSystem.IUsageProvider
	{
		...
		public bool Execute(global::System.ArraySegment<string> arguments, global::CommandSystem.ICommandSender sender, out string response)
		{
			...
			if (list != null)
			{
				...
				{
					if (global::PluginAPI.Events.EventManager.ExecuteEvent(global::PluginAPI.Enums.ServerEventType.PlayerUnmuted, item, true))
					{
						global::VoiceChat.VoiceChatMutes.RevokeLocalMute(item.characterClassManager.UserId, intercom: true);
