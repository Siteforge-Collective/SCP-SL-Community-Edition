namespace CommandSystem.Commands.RemoteAdmin.MutingAndIntercom
{
	...
	public class IntercomMuteCommand : global::CommandSystem.ICommand, global::CommandSystem.IUsageProvider
	{
		...
		public bool Execute(global::System.ArraySegment<string> arguments, global::CommandSystem.ICommandSender sender, out string response)
		{
			...
			if (list != null)
			{
				...
				{
					if (global::PluginAPI.Events.EventManager.ExecuteEvent(global::PluginAPI.Enums.ServerEventType.PlayerMuted, item, true))
					{
						global::VoiceChat.VoiceChatMutes.IssueLocalMute(item.characterClassManager.UserId, intercom: true);
