...
[global::UnityEngine.AddComponentMenu("Camera Filter Pack/ColorsAdjust/Photo Filters")]
public class CameraFilterPack_Colors_Adjust_PreFilters : global::UnityEngine.MonoBehaviour
{
	public enum filters
	{
		Normal = 0,
	...
	private readonly string ShaderName = "CameraFilterPack/Colors_Adjust_PreFilters";
	...
	private void ChangeFilters()
	{
		switch (filterchoice)
		{
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.Normal:
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.Blindness_Deuteranomaly:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.Blindness_Protanopia:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.Blindness_Protanomaly:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.Blindness_Deuteranopia:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.Blindness_Tritanomaly:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.Blindness_Achromatopsia:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.Blindness_Achromatomaly:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.Blindness_Tritanopia:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.BlueLagoon:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.GoldenPink:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.BlueMoon:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.DarkPink:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.RedWhite:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.VintageYellow:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.NashVille:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.PopRocket:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.RedSoftLight:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.BlackAndWhite_Blue:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.BlackAndWhite_Green:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.BlackAndWhite_Orange:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.BlackAndWhite_Red:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.BlackAndWhite_Yellow:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.YellowSunSet:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.Walden:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.WhiteShine:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.Fluo:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.MarsSunRise:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.Amelie:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.BlueJeans:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.NightVision:
			Matrix9 = new float[12]
			{
			...
			break;
		case CameraFilterPack_Colors_Adjust_PreFilters.filters.BlueParadise:
			Matrix9 = new float[12]
			{
