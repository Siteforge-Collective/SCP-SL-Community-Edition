public class NineTailedFoxAnnouncer : global::UnityEngine.MonoBehaviour
{
	...
	[global::System.Serializable]
	public struct ScpDeath : global::System.IEquatable<NineTailedFoxAnnouncer.ScpDeath>
	{
		public global::System.Collections.Generic.List<global::PlayerRoles.RoleTypeId> scpSubjects;
	...
	public global::UnityEngine.AudioClip[] backgroundLines;

	public global::UnityEngine.AudioClip suffixPluralStandard;

	public global::UnityEngine.AudioClip suffixPluralException;

	public global::UnityEngine.AudioClip suffixPastStandard;

	public global::UnityEngine.AudioClip suffixPastException;

	public global::UnityEngine.AudioClip suffixContinuous;
	...
	public global::UnityEngine.AudioSource speakerSource;

	public global::UnityEngine.AudioSource backgroundSource;

	private readonly global::System.Text.RegularExpressions.Regex UniqueKeyRegex = new global::System.Text.RegularExpressions.Regex("(jam_\\d{1,3}_\\d{1,3})|(pitch_[\\d\\.]{1,4})|(\\.g\\d{1,3})|(bell_start)|(bell_end)", global::System.Text.RegularExpressions.RegexOptions.IgnoreCase);

	private readonly global::System.Text.RegularExpressions.Regex WhiteSpaceRegex = new global::System.Text.RegularExpressions.Regex("\\s+");
	...
	public static void AnnounceScpTermination(ReferenceHub scp, global::PlayerStatsSystem.DamageHandlerBase hit)
	{
		...
		if (global::PluginAPI.Events.EventManager.ExecuteEvent(global::PluginAPI.Enums.ServerEventType.CassieAnnouncesScpTermination, scp, hit, announcement))
		{
