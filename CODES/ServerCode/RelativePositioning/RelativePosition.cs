namespace RelativePositioning
{
	public struct RelativePosition : global::Mirror.NetworkMessage, global::System.IEquatable<global::RelativePositioning.RelativePosition>
	{
		...
		public RelativePosition(global::Mirror.NetworkReader reader)
		{
			...
			if (WaypointId > 0)
			{
				PositionX = global::Mirror.NetworkReaderExtensions.ReadInt16(reader);
				PositionY = global::Mirror.NetworkReaderExtensions.ReadInt16(reader);
				PositionZ = global::Mirror.NetworkReaderExtensions.ReadInt16(reader);
			}
			else
			{
				PositionX = 0;
		...
		public void Write(global::Mirror.NetworkWriter writer)
		{
			...
			if (WaypointId > 0)
			{
				global::Mirror.NetworkWriterExtensions.WriteInt16(writer, PositionX);
				global::Mirror.NetworkWriterExtensions.WriteInt16(writer, PositionY);
				global::Mirror.NetworkWriterExtensions.WriteInt16(writer, PositionZ);
			}
		}
