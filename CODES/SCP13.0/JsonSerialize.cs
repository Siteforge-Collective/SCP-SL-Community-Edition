...
public static class JsonSerialize
{
    ...
    {
        CompositeResolver.RegisterAndSetAsDefault(DynamicGenericResolver.Instance, BuiltinResolver.Instance, EnumResolver.Default, UnityResolver.Instance, StandardResolver.Default);
    }
