...
public class GameConsoleTransmission : NetworkBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            EncryptedChannelManager.RegisterClientHandler(EncryptedChannelManager.EncryptedChannel.GameConsole, ClientHandleMessage);
            if (NetworkServer.active)
            {
                EncryptedChannelManager.RegisterServerHandler(EncryptedChannelManager.EncryptedChannel.GameConsole, ServerHandleCommand);
            }
        }
    }
