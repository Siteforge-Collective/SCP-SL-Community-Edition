...
public class YamlConfig : ConfigRegister
{
    ...
    public override void UpdateConfigValue(ConfigEntry configEntry)
    {
        ...
        if (configEntry is not ConfigEntry<bool> configEntry2)
        {
            if (configEntry is not ConfigEntry<byte> configEntry3)
            {
                if (configEntry is not ConfigEntry<char> configEntry4)
                {
                    if (configEntry is not ConfigEntry<decimal> configEntry5)
                    {
