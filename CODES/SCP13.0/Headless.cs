...
public static class Headless
{
    ...
    public static bool checkedHeadless = false;

    public static bool initializedHeadless = false;

    public static bool buildingHeadless = false;

    public static bool debuggingHeadless = false;

    public static HeadlessRuntime headlessRuntime;
