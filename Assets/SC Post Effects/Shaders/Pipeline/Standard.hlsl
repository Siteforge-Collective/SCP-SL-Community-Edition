...
//Generic functions — _MainTex already declared above, prevent SCPE.hlsl from re-declaring it
#define SCPE_MAINTEX_INCLUDED
#include "../SCPE.hlsl"
#define LightProjectionMultiplier 300 //Magic scalar to match the transform's actual worldToLocalMatrix
