...
namespace SCPE
{
    ...
    public sealed class HueShift3DEditor : PostProcessEffectEditor<HueShift3D>
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(HueShift3D.isOrtho || GraphicsSettings.defaultRenderPipeline != null);
            {
                ...
                if (GraphicsSettings.defaultRenderPipeline != null) EditorGUILayout.HelpBox("Not available when using a custom render pipeline", MessageType.None);
            }
