...
namespace PlayerRoles.PlayableScps.Scp173
{
    public class Scp173TeleportIndicator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            _subroutineManager.TryGetSubroutine(out _teleportAbility);
            _subroutineManager.TryGetSubroutine(out _breakneckSpeedsAbility);
        }
        ...
        private void Update()
        {
            _soundSource.volume = Mathf.MoveTowards(
                _soundSource.volume, 
                _targetVolume, 
                _volumeAdjustmentSpeed * Time.deltaTime
            );
        }
        ...
        public void UpdateVisibility(bool isVisible)
        {
            ...
            bool hasTarget = _teleportAbility.BestTarget != null;
            SetupVisiblity(normal: !hasTarget, kill: hasTarget, neutral: false);
        }
    }
}
