...
{
	public class Scp939DamagedEffect : ScpStandardSubroutine<Scp939Role>
	{
		...
		public override void SpawnObject()
		{
			...
			if (NetworkServer.active)
			{
				...
				_hume = base.ScpRole.HumeShieldModule as DynamicHumeShieldController;
				_eventAssigned = true;
		...
		public override void ClientProcessRpc(NetworkReader reader)
		{
			...
			if (base.ScpRole.FpcModule.CharacterModelInstance is Scp939Model scp939Model)
			{
