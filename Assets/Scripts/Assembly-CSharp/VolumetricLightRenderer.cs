...
public class VolumetricLightRenderer : MonoBehaviour
{
    ...
    public void OnPreRender()
    {
        ...
        {
            Texture source = null;
            _preLightPass.Blit(source, _halfDepthBuffer, _bilateralBlurMaterial, (!flag) ? 10 : 4);
            _preLightPass.Blit(source, _quarterDepthBuffer, _bilateralBlurMaterial, (!flag) ? 11 : 6);
            _preLightPass.SetRenderTarget(_quarterVolumeLightTexture);
        }
        else if (Resolution == VolumtericResolution.Half)
        {
            Texture source2 = null;
            _preLightPass.Blit(source2, _halfDepthBuffer, _bilateralBlurMaterial, (!flag) ? 10 : 4);
