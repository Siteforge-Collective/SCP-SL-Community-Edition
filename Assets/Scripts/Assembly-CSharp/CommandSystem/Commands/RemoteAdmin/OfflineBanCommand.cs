namespace CommandSystem.Commands.RemoteAdmin
{
	...
	public class OfflineBanCommand : global::CommandSystem.ICommand, global::CommandSystem.IUsageProvider
	{
		...
		public bool Execute(global::System.ArraySegment<string> arguments, global::CommandSystem.ICommandSender sender, out string response)
		{
			...
			{
				text = global::System.Linq.Enumerable.Aggregate(global::System.Linq.Enumerable.Skip(arguments, 2), (string current, string n) => current + " " + n);
			}
			long num = 0L;
			try
			{
