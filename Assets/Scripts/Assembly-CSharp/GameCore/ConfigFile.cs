namespace GameCore
{
    ...
    {
        public static global::System.Action OnConfigReloaded;
        ...
        public static global::System.Collections.Generic.Dictionary<string, int[]> smBalancedPicker;
        ...
        static ConfigFile()
        {
            ...
            {
                global::System.IO.Directory.CreateDirectory(FileManager.GetAppFolder());
            }
            if (global::System.IO.File.Exists(FileManager.GetAppFolder() + "config.txt") && !global::System.IO.File.Exists(FileManager.GetAppFolder() + "LEGACY CONFIG BACKUP - NOT WORKING.txt"))
            {
                global::System.IO.File.Move(FileManager.GetAppFolder() + "config.txt", FileManager.GetAppFolder() + "LEGACY CONFIG BACKUP - NOT WORKING.txt");
            }
        ...
        public static void ReloadGameConfigs(bool firstTime = false)
        {
            ...
            global::Security.RateLimitCreator.Load();
            ...
            global::GameCore.ConfigSharing.Reload();
            BanHandler.Init();
            WhiteList.Reload();
            ReservedSlot.Reload();
            ...
            ServerConsole.CustomGamemodeServerConfig = ServerConfig.GetBool("custom_gamemode_server");
            ServerConsole.HeavilyModdedServerConfig = ServerConfig.GetBool("heavily_modded_server");
            ...
            ServerConsole.EnforceSameAsn = ServerConfig.GetBool("enforce_same_asn", def: true);
            ...
            CharacterClassManager.OnlineMode = ServerConfig.GetBool("online_mode", def: true);
            CharacterClassManager.CuffedChangeTeam = ServerConfig.GetBool("cuffed_escapee_change_team", def: true);
            CharacterClassManager.ForceCuffedChangeTeam = ServerConfig.GetBool("force_cuffed_escapee_change_team", def: true);
            ...
            global::LightContainmentZoneDecontamination.DecontaminationController.AutoDeconBroadcastEnabled = ServerConfig.GetBool("auto_decon_broadcast_enabled");
            global::LightContainmentZoneDecontamination.DecontaminationController.DeconBroadcastDeconMessage = ServerConfig.GetString("auto_decon_broadcast_message", "Light Containment Zone is being decontaminated");
            global::LightContainmentZoneDecontamination.DecontaminationController.DeconBroadcastDeconMessageTime = ServerConfig.GetUShort("auto_decon_broadcast_time", 10);
            ...
            if (!(text == "whitelist"))
            {
                if (text == "blacklist")
                {
                    ...
                    {
                        CustomLiteNetLib4MirrorTransport.GeoblockingList.Add(@string.ToUpper());
                    }
                }
                else
                {
            ...
            else
            {
                ...
                {
                    CustomLiteNetLib4MirrorTransport.GeoblockingList.Add(string2.ToUpper());
                }
            }
            ServerRoles.AllowSameAccountJoining = ServerConfig.GetBool("same_account_joining");
            CustomLiteNetLib4MirrorTransport.IpPassthroughEnabled = CharacterClassManager.OnlineMode && ServerConfig.GetBool("enable_proxy_ip_passthrough");
            if (CustomLiteNetLib4MirrorTransport.IpPassthroughEnabled)
            {
                if (CustomLiteNetLib4MirrorTransport.TrustedProxies == null)
                {
                    CustomLiteNetLib4MirrorTransport.TrustedProxies = new global::System.Collections.Generic.HashSet<global::System.Net.IPAddress>();
                }
                else
                {
                ...
                {
                    if (global::System.Net.IPAddress.TryParse(string3, out var address))
                    {
                        CustomLiteNetLib4MirrorTransport.TrustedProxies.Add(address);
                    }
                    else
                    {
                        ServerConsole.AddLog("Couldn't parse trusted proxy IP address: " + string3, global::System.ConsoleColor.Red);
                    }
                }
                ...
                {
                    CustomLiteNetLib4MirrorTransport.RealIpAddresses = new global::System.Collections.Generic.Dictionary<int, string>();
                }
            }
            else
            {
            ...
            catch
            {
                ...
                global::GameCore.Console.AddLog("Failed to parse Friendly Fire Detector ban times. Using default values...", global::UnityEngine.Color.red);
            }
        ...
        public static string GetConfigPath(string name)
        {
            ...
            if (global::System.IO.File.Exists(appFolder + name + ".txt"))
            {
                return appFolder + name + ".txt";
            }
            try
            {
                global::System.IO.File.Copy("ConfigTemplates/" + name + ".template.txt", appFolder + name + ".txt");
            }
