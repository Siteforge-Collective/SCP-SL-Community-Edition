namespace MiniEXR
{
    internal static class HalfHelper
    {
        ...
        {
            return global::System.BitConverter.ToSingle(global::System.BitConverter.GetBytes(mantissaTable[offsetTable[half >> 10] + (half & 0x3FF)] + exponentTable[half >> 10]), 0);
        }

        public static ushort SingleToHalf(float single)
        {
            uint num = global::System.BitConverter.ToUInt32(global::System.BitConverter.GetBytes(single), 0);
