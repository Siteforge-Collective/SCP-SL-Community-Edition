namespace Security
{
    public class RateLimit
    {
        ...
        private readonly global::Mirror.NetworkConnection _conn;

        public RateLimit(int usagesAllowed, float timeWindow, global::Mirror.NetworkConnection conn = null)
        {
        ...
        public bool CanExecute(bool countUsage = true)
        {
            ...
            if (_timeWindow >= 0f && global::UnityEngine.Time.fixedUnscaledTime - _usageTime > _timeWindow)
            {
                _usages = 1u;
                _usageTime = global::UnityEngine.Time.fixedUnscaledTime;
                return true;
            }
