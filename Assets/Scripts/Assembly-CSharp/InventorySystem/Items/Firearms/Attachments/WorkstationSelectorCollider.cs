...
namespace InventorySystem.Items.Firearms.Attachments
{
    ...
    {
        public const float HighlightColor = 0.71f;

        public const float DefaultColor = 0.38f;

        public const float CurrentColor = 0.54f;

        public const float LerpSpeed = 12f;

        public const float SizeRatio = 1f;

        public const float MinColliderWidth = 40f;

        public const float MinColliderDepth = 0.2f;
        ...
        public void UpdateColors(AttachmentSlot slot)
        {
            ...
            {
                // Disabled while highlighted: drop the latch so the crosshair leaving it is not
                // swallowed and the button re-highlights correctly once it is shown again.
                _prevHighlighted = false;
                return;
            }
            ...
            bool flag = CenterScreenRaycast.LastRaycastHit.collider == _collider && CenterScreenRaycast.LastRaycastHit.distance < 3.35f;
