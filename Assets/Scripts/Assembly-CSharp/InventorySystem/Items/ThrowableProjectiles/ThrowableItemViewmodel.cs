...
namespace InventorySystem.Items.ThrowableProjectiles
{
    ...
    {
        public static readonly int AimHash = Animator.StringToHash("Aim");

        public static readonly int ThrowWeakHash = Animator.StringToHash("ThrowWeak");

        public static readonly int ThrowFullHash = Animator.StringToHash("ThrowFull");

        public static readonly int GrenadeModifier = Animator.StringToHash("SpeedModifier");
        ...
        public void ProcessAnim(ThrowableNetworkHandler.RequestType request)
        {
            switch (request)
            {
        ...
        public void OnMsgReceived(ThrowableNetworkHandler.ThrowableItemAudioMessage msg)
        {
