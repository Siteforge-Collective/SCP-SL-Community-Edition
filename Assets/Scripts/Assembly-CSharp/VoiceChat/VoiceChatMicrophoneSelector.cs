namespace VoiceChat
{
    public class VoiceChatMicrophoneSelector : global::TMPro.TMP_Dropdown
    {
        private const string PrefsKeyMicName = "VcMicName";

        private static string _defaultOption;

        private static global::System.Collections.Generic.List<global::TMPro.TMP_Dropdown.OptionData> _noMicError;
        ...
        private void SetOption(int index, string text)
        {
            ...
            {
                base.options.Add(new global::TMPro.TMP_Dropdown.OptionData());
            }
        ...
        private void OnValueChanged(int i)
        {
            ...
            global::VoiceChat.VoiceChatMicCapture.RestartRecording();
        }
        ...
        private static void Init()
        {
            TranslationReader.OnTranslationsRefreshed += delegate
            {
                ...
                _noMicError = new global::System.Collections.Generic.List<global::TMPro.TMP_Dropdown.OptionData>
                {
                    new global::TMPro.TMP_Dropdown.OptionData(TranslationReader.Get("Facility", 46, "No Microphone Detected!"))
                };
            };
        }
